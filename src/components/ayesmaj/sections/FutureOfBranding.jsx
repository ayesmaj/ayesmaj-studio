...
const ARTWORK = [
  { src: "/brands/blenday/1.webp", alt: "Purple Blenday campaign and packaging artwork", label: "Campaign / Packaging" },
  { src: "/videos/websites/posters/electric-fuel-america.webp", alt: "Electric Fuel America cinematic website", label: "Web / Motion", position: "center 40%" },
  { src: "/concepts/orbit-footwear.webp", alt: "Futuristic performance footwear visualization", label: "Product / CGI" },
  { src: "/brands/paranormal/1.webp", alt: "Paranormal luxury bottle branding", label: "Identity / Packaging" },
  { src: "/brands/ashe/3.webp", alt: "Ashe black and gold identity system", label: "Brand / Identity" },
  { src: "/videos/websites/posters/podos-ai.webp", alt: "Podos AI immersive technology website", label: "AI / Web Experience", position: "center 56%" },
  ...
  { src: "/images/car-final.webp", alt: "Performance car in a cinematic garage", label: "Automotive / CGI" },
