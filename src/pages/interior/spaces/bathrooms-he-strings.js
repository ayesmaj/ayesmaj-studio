...
export const T = {
  ...
  navGroupSpaces: 'חללים',
  navGroupTypes: 'סוגי נכסים',
  navKitchens: 'מטבחים',
  navKitchensLine: 'החדר שהכול סובב סביבו.',
  navBathrooms: 'חדרי רחצה',
  navBathroomsLine: 'אבן, מים, אור.',
  navFurniture: 'ריהוט ועיצוב',
  navFurnitureLine: 'החלל בנוי — עכשיו נותנים לו חיים.',
  navApartments: 'דירות',
  navApartmentsLine: 'רואים את הדירה כולה, ואז נכנסים פנימה.',
  navHomes: 'בתים פרטיים',
  navHomesLine: 'מבינים את הבית כולו, חווים כל פינה.',
  navBuildings: 'בניינים ופרויקטים',
  navBuildingsLine: 'ממודל הבניין אל עולם שהקונים נכנסים אליו.',
  navHereNote: 'העמוד הנוכחי',
