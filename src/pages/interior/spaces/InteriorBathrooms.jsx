...
const cfg = {
  ...
  chapters: [
    ...
    { kind: 'compare', bgc: '06', eyebrow: 'SHELL → DESIGNED', title: ['Same room.', 'New bathroom.'], gradient: [1], lede: 'The empty shell and the designed bathroom from the same camera — walls, window and drainage positions locked while the room is worked into the real shell. Poolside Villa; both views visualized.', before: '07_bathroom_before', after: '08_bathroom_after', beforeLabel: 'SHELL', afterLabel: 'DESIGNED' },
