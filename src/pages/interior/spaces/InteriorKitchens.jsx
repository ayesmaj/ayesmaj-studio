...
const KITCHEN_MODELS = ['kitchen-island', 'kitchen-2', 'kitchen-3', 'sinks'].map((key) => MODELS.objects.find((m) => m.key === key)).filter(Boolean);
...
const cfg = {
  ...
  chapters: [
    ...
    { kind: 'full', media: '08_kitchen_cinematic_frame', eyebrow: 'THE FINISHED KITCHEN', title: ['Evening light across', 'stone and walnut.'], gradient: [] },
    { kind: 'elastic', ariaLabel: 'Kitchen layouts', eyebrow: 'LAYOUTS', title: ['Six ways', 'to plan a kitchen.'], gradient: [1], lede: 'One-wall, galley, L-shaped, U-shaped, island and double island — compared on the same footprint. Hover or tap a layout to open it; the decision is about how you cook, not about a drawing.', options: [{ media: '02_kitchen_layout_one-wall', label: 'One wall', line: 'Everything on a single run — the smallest honest kitchen.' }, { media: '02_kitchen_layout_galley', label: 'Galley', line: 'Two runs, one aisle — the most efficient cook’s kitchen.' }, { media: '02_kitchen_layout_l-shaped', label: 'L-shaped', line: 'Two walls, an open corner — room for a table.' }, { media: '02_kitchen_layout_u-shaped', label: 'U-shaped', line: 'Three walls of storage and worktop around one cook.' }, { media: '02_kitchen_layout_island', label: 'Island', line: 'The run plus an island — cooking faces the room.' }, { media: '02_kitchen_layout_double-island', label: 'Double island', line: 'Prep on one, serve on the other — the entertaining kitchen.' }] },
