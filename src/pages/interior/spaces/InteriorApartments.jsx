        ...
        <div style={{ display: 'grid', gap: 16 }}>
          ...
          <div className="ap-typo idv2-reveal">
            <figure style={{ margin: 0 }}>
              <img key={active.key} {...imgProps(active.m, SW_FIG)} alt={active.m.alt} loading="lazy" decoding="async" style={{ width: '100%', maxHeight: 'min(58vh, calc(100svh - 480px))', objectFit: 'contain', borderRadius: 20, display: 'block' }} />
