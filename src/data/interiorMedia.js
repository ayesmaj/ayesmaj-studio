...
export const MODELS = {
  ...
  featured: { key: 'the-patel', name: 'The Patel — Miami', file: '/interior-design/models/the-patel.glb', weight: '7.2 MB', lite: '/interior-design/models/the-patel-lite.glb', liteWeight: '3.9 MB', credit: 'CLIENT PROJECT', line: 'Not a stock asset: the actual tower model behind The Patel development presentation. Walk the massing, the balconies, and the crown.' },
  ...
  project: [
    { key: 'villa-floor-plan', scale: 'PLAN', name: 'Poolside Villa — floor-plan scan', file: '/interior-design/models/villa-floor-plan.glb', weight: '5.1 MB', lite: '/interior-design/models/villa-floor-plan-lite.glb', liteWeight: '3.2 MB', credit: 'CLIENT PROJECT · AI 3D SCAN', line: 'The villa\'s floor plan as a 3D object: an AI scan of the real layout — walls, openings and levels you can turn and read from above.' },
    { key: 'villa-house', scale: 'HOUSE', name: 'Poolside Villa — house scan', file: '/interior-design/models/villa-house.glb', weight: '5.5 MB', lite: '/interior-design/models/villa-house-lite.glb', liteWeight: '5.5 MB', credit: 'CLIENT PROJECT · AI 3D SCAN', line: 'The whole villa captured as an AI 3D scan: massing, terraces and the pool deck — the same house the renders and the film are built on.' },
  ],
  ...
  spaces: [
    ...
    { key: 'house', scale: '03', name: 'Coastal hillside house', file: '/interior-design/models/house.glb', weight: '4.9 MB', lite: '/interior-design/models/house-lite.glb', liteWeight: '4.6 MB', credit: 'SHOWCASE MODEL', line: 'The whole home at one glance - levels, terraces, and the drop of the site.' },
    ...
    { key: 'plan-study', scale: '05', name: 'Floor-plan study', file: '/interior-design/models/plan-study.glb', weight: '4.5 MB', lite: '/interior-design/models/plan-study-lite.glb', liteWeight: '3.4 MB', credit: 'SHOWCASE MODEL', line: 'The layout as an object: rooms, walls, and circulation in the round.' },
  ],
  objects: [
    ...
    { key: 'kitchen-3', scale: '11', name: 'Kitchen concept 03', file: '/interior-design/models/kitchen-3.glb', weight: '4.4 MB', lite: '/interior-design/models/kitchen-3-lite.glb', liteWeight: '3.5 MB', credit: 'SHOWCASE MODEL' },
  ],
};
